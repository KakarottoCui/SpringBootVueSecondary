			...
			<el-table :data="HouseUpRecordList" border stripe>
				...
				<el-table-column label="操作">
					<template slot-scope="scope">
						<el-button type="info" size="small" @click="housedetail=true,getHouseDetail(scope.row)">查看</el-button>
						<el-button type="primary" size="small" @click="HUsubmit(scope.row.houid)" v-show="scope.row.state==-1">重新通过</el-button>
						...
						<el-button type="primary" size="small" @click="HUrefuse(scope.row.houid)" v-show="scope.row.state!=-1">拒绝</el-button>
